...
public class ProductFavoriteModel {
    ...
    public ProductFavoriteModel(int idProduct, String nameProduct, int statusProduct, String imgProduct, String tasteProduct, int priceProduct, int discountProduct) {
